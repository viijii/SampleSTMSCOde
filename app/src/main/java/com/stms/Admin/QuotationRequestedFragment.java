...
public class QuotationRequestedFragment extends Fragment {

    View view;
    RecyclerView listview;
    ConnectionDetector cd;
    SwipeRefreshLayout swipeRefreshLayout;
    QuotationRequestedAdapter quotationRequestedAdapter;
    QuotationsResponse quotationsResponse;
    ArrayList<QuotationsResponse.data> data = new ArrayList<>();

    public QuotationRequestedFragment() {
        // Required empty public constructor
    }


    public static QuotationRequestedFragment newInstance(String param1, String param2) {
        QuotationRequestedFragment fragment = new QuotationRequestedFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_quotation_requested, container, false);
    ...
    {
        quotationRequestedAdapter = new QuotationRequestedAdapter(getActivity(),data,QuotationRequestedFragment.this);
        listview.setAdapter(quotationRequestedAdapter);
    }
    ...
    public void getRequestedQuotes() {
        try {
            ...
            if (cd.isConnectingToInternet()) {
                ...
                Call<QuotationsResponse> call = api.getReqQuotations("requested",Config.getLoginUserType(getActivity()).toLowerCase(),
