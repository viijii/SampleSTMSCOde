...
public class ImageUpload extends AppCompatActivity {
    ...
    Intent intent;
    String title,description,vehicleId,imagePath;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        vehicleId=intent.getStringExtra("spinner");

        Log.d(TAG, "onCreate: title"+title);
        Log.d(TAG, "onCreate: des"+description);
        Log.d(TAG, "onCreate: veh"+vehicleId);
    ...
    public void UploadImageToServer(){
        ...
        class AsyncTaskUploadClass extends AsyncTask<Void,Void,String> {
            ...
            protected void onPostExecute(String string1) {
                ...
                Intent i=new Intent(ImageUpload.this,Customer_dashboard.class);
                startActivity( i );
            }
            ...
            protected String doInBackground(Void... params) {
                ...
                //testing
                      HttpPost httppost = new HttpPost("http://115.98.3.215:90/sRamapptest/imageupload.php");
             //production
              //  HttpPost httppost = new HttpPost("http://71.40.116.146/sRamapp_prod/imageupload.php");
                List<NameValuePair> nameValuePairs = new ArrayList<NameValuePair>(0);
                nameValuePairs.add(new BasicNameValuePair("action","complaintRequest" ));
                nameValuePairs.add(new BasicNameValuePair("imagePath", filepath));
                nameValuePairs.add(new BasicNameValuePair("title", title));
                nameValuePairs.add(new BasicNameValuePair("description", description));
                nameValuePairs.add(new BasicNameValuePair("customerId", Config.getUserId( getApplicationContext() )));
