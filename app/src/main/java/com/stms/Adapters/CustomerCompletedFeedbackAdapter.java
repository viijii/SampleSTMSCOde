...
public class CustomerCompletedFeedbackAdapter extends RecyclerView.Adapter<CustomerCompletedFeedbackAdapter.EMSHolder> implements Filterable {
    ...
    int i=0;
    CustomerFeedbackPage customerFeedbackPage;


    public CustomerCompletedFeedbackAdapter(Activity con, ArrayList<AdminRequestedResponse.data> data,
                                            CustomerFeedbackPage CustomerFeedbackPage)
    {
        this.con = con;
        this.data = data;
        this.customerFeedbackPage = CustomerFeedbackPage;
        this.dataFilter = new ArrayList<AdminRequestedResponse.data>();
        this.dataFilter.addAll(data);
    }

    @Override
    public void onBindViewHolder(@NonNull CustomerCompletedFeedbackAdapter.EMSHolder holder, final int position) {
    ...
    public CustomerCompletedFeedbackAdapter.EMSHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.customer_completed_adapter,
                parent, false);

        return new CustomerCompletedFeedbackAdapter.EMSHolder(itemView);
    }
