...
public class MyTaskCompletedAdapter extends RecyclerView.Adapter<MyTaskCompletedAdapter.EMSHolder>implements Filterable {
    ArrayList<MyTaskResponse.data> data;
    ArrayList<MyTaskResponse.data>dataFilter;
    Activity con;
    int selectedIndex = -1,i=0;
    int FADE_DURATION = 100;
    CompletedTaskListFragment completedTaskListFragment;
    Context context;
    otpRes res;
    String valOtp="";
    int place=0;
    ...
    public MyTaskCompletedAdapter(Activity con,ArrayList <MyTaskResponse.data> data,CompletedTaskListFragment completedTaskListFragment,Context context)
    {
        this.con = con;
        this.context = context;
        this.data = data;
        this.completedTaskListFragment = completedTaskListFragment;
    ...
    {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_my_task_completed_adapter,
                parent, false);
